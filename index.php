              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="<?php echo $full_url. '/' .$abc['image'];?>" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="#"><?php echo $abc['name'];?></a></h3>
                    <p class="mb-0"></p>
                    <p class="text-primary font-weight-bold">₹<?php echo $abc['price'];?></p>
                  </div>
                </div>
              </div>
